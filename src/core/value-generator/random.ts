...
export class Random {
  ...
  */
  public static String(options: { length?: number, casing?: 'upper', alpha?: boolean, numeric?: boolean } = { length: 8, alpha: true }): iValueGenerator {
    return () => {
  ...
  */
   ...
   */
  public static Street(options: { country: 'it' | 'us', syllables?: number, short_suffix?: boolean } = { country: 'us' }): iValueGenerator {
    return () => {
